      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 ">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-10">
          ...
          <div className="bg-white rounded-2xl p-6 sm:p-8 border border-slate-200/80 shadow-md hover:shadow-xl transition-all flex flex-col sm:flex-row gap-6 items-center sm:items-start group">
            <div className="relative w-28 h-28 sm:w-48 sm:h-55 rounded-2xl overflow-hidden shrink-0 shadow-md transition-colors">
              <Image
            ...
            <div className="flex-1 text-center sm:text-left">
              ...
              <p className="text-xs sm:text-sm lg:text-base   text-slate-600 italic leading-relaxed">
