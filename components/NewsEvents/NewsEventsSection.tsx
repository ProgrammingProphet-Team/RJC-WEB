        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <div>
              ...
              <div className="flex items-center justify-between pb-4 mb-4 border-b border-slate-100">
                <div className="flex items-center space-x-2">
                  <Megaphone className="w-5 h-5 text-[#781628]" />
                ...
                <button
                  ...
                  className="text-xs font-semibold text-[#781628] hover:underline flex items-center gap-1 cursor-pointer"
                >
                  <span>View All</span>
              ...
              <div className="space-y-3.5">
                {announcementsData.map((item) => (
                  ...
                  >
                    {/* Date Block */}
                    <div className="shrink-0 w-11 text-center bg-slate-100 group-hover:bg-[#781628] group-hover:text-white rounded-md py-1 px-1 transition-colors">
                      <div className="font-serif font-bold text-sm leading-none">
                        {item.day}
                      </div>
                      <div className="text-[10px] uppercase font-semibold text-slate-500 group-hover:text-rose-100">
                        {item.month}
                      </div>
                    </div>
                    ...
                    <div className="min-w-0 flex-1">
                      <div className="text-xs font-medium text-slate-800 group-hover:text-[#781628] transition-colors leading-snug line-clamp-2">
                        {item.title}
                        {item.isNew && (
          ...
          <div className="lg:col-span-4 flex flex-col justify-between p-6 rounded-2xl border border-slate-200/80 bg-white shadow-xs">
            <div>
              ...
              <div className="flex items-center justify-between pb-4 mb-4 border-b border-slate-100">
                <div className="flex items-center space-x-2">
                  <Calendar className="w-5 h-5 text-[#781628]" />
                  <h3 className="font-serif font-bold text-lg text-slate-900">
                    Events &amp; Activities
                  </h3>
                </div>
          ...
          <div className="lg:col-span-4">
            <div className="relative h-full min-h-[300px] rounded-2xl overflow-hidden shadow-xl bg-[#520d1b] flex flex-col justify-end p-6 sm:p-8 text-white group border border-rose-900/30">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-[#3a0610] via-[#520d1b]/80 to-transparent" />

              {/* Content */}
              <div className="relative z-10 space-y-4">
                <div className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-white/10 backdrop-blur-md text-[10px] font-mono tracking-widest text-rose-200 uppercase">
                ...
                <p className="text-xs text-rose-200/90 font-medium tracking-wide">
                ...
                <div className="pt-2">
                  <button
                    ...
                    className="w-full sm:w-auto inline-flex items-center justify-center space-x-2 bg-[#781628] hover:bg-[#631120] text-white px-6 py-2.5 rounded-md font-semibold text-xs tracking-wide transition-all shadow-lg active:scale-95 cursor-pointer border border-rose-400/30 group/btn"
                  >
