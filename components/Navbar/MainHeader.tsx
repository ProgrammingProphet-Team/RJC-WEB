      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3.5 sm:gap-5 text-center md:text-left">
          ...
          <Link href="/" className="shrink-0 group">
            <div className="relative w-20 h-20 sm:w-25 sm:h-25 transition-transform duration-300 ">
              <Image
          ...
          {/* Typography Details */}
          <div>
            <div className="text-xs sm:text-sm font-medium font-semibold text-slate-700 tracking-wide ">
              Hindi Vidya Prachar Samiti&apos;s
            </div>

            <h1 className="font-bold text-lg sm:text-2xl md:text-3xl  text-rose-900 leading-tight tracking-tight uppercase ">
              Ramniranjan Jhunjhunwala College
            </h1>

            <div className="font-bold text-sm sm:text-lg md:text-[18px] text-rose-900 uppercase  tracking-wide word-space">
              Of Arts, Science &amp; Commerce
            </div>

            <div className="mt-1 flex flex-wrap items-center justify-center md:justify-start gap-1.5 sm:gap-2">
              <span className="inline-block bg-rose-900 text-white text-[10px] sm:text-[11px] font-bold px-2.5 py-0.5 rounded-full uppercase tracking-wider shadow-xs">
        ...
        <div className="hidden lg:flex flex-col items-end justify-center border-b-2 border-rose-800 pb-2 pl-6  text-right">
          <div className="font-serif italic font-medium text-slate-800 text-lg tracking-wide leading-snug">
